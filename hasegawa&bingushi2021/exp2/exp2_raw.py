...
disparity = -6 # Horizon disparity between test and control stimulus 
#------------------------------------------------------------------------
...
test = DrawStim.Quad(5, am42, cntx + deg1 * iso * test_x, cnty, rc, 0, 0)
...
for i in range(dl):
    ...
    updot = DrawStim.Quad(5, 5, cntx + deg1 * iso * -test_x + cola, cnty + am42 / 2 - 2.5 + 7.5, 0, 0, 0)
    downdot = DrawStim.Quad(5, 5, cntx + deg1 * iso * -test_x + cola, cnty - am42 / 2 + 2.5 - 7.5, 0, 0, 0)
